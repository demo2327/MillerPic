...
- `CKV_AWS_50` (Lambda X-Ray) — owner: MillerPic Platform Team; next review: 2026-10-02 (reviewed 2026-07-02, no change).
- `CKV_AWS_18` (S3 access logging) — owner: MillerPic Platform Team; next review: 2026-10-02 (reviewed 2026-07-02, no change).
